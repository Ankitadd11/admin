          ...
          <div class="x_content"> <br />
            <form id="ServiceForm"  class="form-horizontal form-label-left" action="<?php echo base_url().$action; ?>" method="post" enctype="multipart/form-data" onsubmit="window.onbeforeunload = null;">
              <div class="form-group">
                  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Service Title 
                  </label>
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" id="service_type_title" required="required" name="service_type_title" class="form-control col-md-7 col-xs-12" value="<?php echo $service_type_title; ?>" disabled="disabled">
                  </div>
              </div>
              <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                     <textarea id="message" required="required" class="form-control" name="service_type_description" data-parsley-trigger="keyup" data-parsley-minlength="20" data-parsley-maxlength="100" data-parsley-minlength-message="Come on! You need to enter at least a 20 caracters long comment.."
                      data-parsley-validation-threshold="10" disabled="disabled"><?php echo $service_type_description;  ?></textarea>
                  </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                  <button class="btn btn-primary" type="button" onclick="document.location.href='<?php echo base_url()?>services'">Return</button>
                </div>
              </div>
            </form>
          </div>
