            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form id="ServiceForm"  class="form-horizontal form-label-left" action="add" method="post" enctype="multipart/form-data" onsubmit="window.onbeforeunload = null;">

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Service Title <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="service_type_title" required="required" name="service_type_title" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
